...
export default function Page() {
  return (
    <div className="flex items-start overflow-hidden sm:flex-row sm:justify-between sm:gap-4">
      <div>
        <h1 className="h1-bold">Privacy Policy</h1>
        <ol>
          <li>
          ...
          <li>
            <div className="paragraph-container">
              <p className="italic hover:not-italic">
                1. Privacy Policy for QAGPT LLC Effective Date: Dec 02 2023
              </p>
              <p className="italic hover:not-italic">
                Welcome to QAGPT LLC (&amp;quot;we,&quot; &quot;us,&quot; or
                &quot;our&quot;). This This Privacy Policy outlines how we
                collect, use, disclose, and protect your personal information
                when you use our website and services.
              </p>
              <p className="italic hover:not-italic">
                QAGPT, LLC. (“us”, “we”, or “our”) operates
                <a href="https://qagpt.co"> https://qagpt.co </a> (hereinafter
                referred to as “Service”). Our Privacy Policy governs your visit
                to
                <a href="https://qagpt.co"> https://qagpt.co </a>, and explains
              ...
              <p className="italic hover:not-italic">
                Definitions SERVICE means the{" "}
                <a href="https://qagpt.co"> https://qagpt.co </a> website
                operated by QAGPT, LLC. PERSONAL DATA means data about a living
              ...
              <p className="italic hover:not-italic">
                ...
                identifiers and other diagnostic data. When you access Service
                with a mobile device, this Usage Data may include information
              ...
              <p className="italic hover:not-italic">
                ...
                be able to use some portions of our Service. Examples of Cookies
                we use:
                <ul>
                  <li>
              ...
              <p className="italic hover:not-italic">
                Use of Data QAGPT, LLC. uses the collected data for various
                purposes:
                <ul>
              ...
              <p className="italic hover:not-italic">
                Retention of Data We will retain your Personal Data only for as
              ...
              <p className="italic hover:not-italic">
                Transfer of Data Your information, including Personal Data, may
                ...
                we transfer the data, including Personal Data, to United States
                and process it there. Your consent to this Privacy Policy
                followed by your submission of such information represents your
                agreement to that transfer. QAGPT, LLC. will take all the steps
              ...
              <p className="italic hover:not-italic">
                ...
                collect, or you provide: Disclosure for Law Enforcement. Under
                certain circumstances, we may be required to disclose your
                Personal Data if required to do so by law or in response to
                valid requests by public authorities. Business Transaction. If
                we or our subsidiaries are involved in a merger, acquisition or
                asset sale, your Personal Data may be transferred. Other cases.
                We may disclose your information also: to our subsidiaries and
                affiliates; to contractors, service providers, and other third
                parties we use to support our business; for any other purpose
                disclosed by us when you provide the information; 9. Security of
                Data The security of your data is important to us but remember
              ...
              <p className="italic hover:not-italic">
                ...
                Regulation (GDPR). If you are a resident of the European Union
                (EU) and European Economic Area (EEA), you have certain data
                protection rights, covered by GDPR. – See more at{" "}
                <a href="https://eur-lex.europa.eu/eli/reg/2016/679/oj">GDPR</a>
                . We aim to take reasonable steps to allow you to correct,
                amend, delete, or limit the use of your Personal Data. If you
                wish to be informed about the Personal Data we hold about you
                and if you want it to be removed from our systems, please email
                us at <a href="mailto:support@qagpt.co">support@qagpt.co</a>
                Our Policy on “Do Not Track” Signals: We honor Do Not Track
                signals and do not track, plant cookies, or use advertising when
                a Do Not Track browser mechanism is in place. Do Not Track is a
              ...
              <p className="italic hover:not-italic">
                ...
                Privacy Act (CCPA) If you are a California resident, you are
                ...
                request, we will return to you: The categories of personal
                information we have collected about you. The categories of
                sources from which we collect your personal information. The
                business or commercial purpose for collecting or selling your
                personal information. The categories of third parties with whom
                we share personal information. The specific pieces of personal
                information we have collected about you. A list of categories of
                personal information that we have sold, along with the category
                of any other company we sold it to. If we have not sold your
                personal information, we will inform you of that fact. A list of
                categories of personal information that we have disclosed for a
                business purpose, along with the category of any other company
                ...
                about you in the previous 12 months. To delete your personal
                information. If you make this request, we will delete the
                personal information we hold about you as of the date of your
                request from our records and direct any service providers to do
                ...
                functions that require your personal information to operate. To
                stop selling your personal information. We do not sell your
                personal information for monetary consideration. However, under
                some circumstances, a transfer of personal information to a
                third party, or within our family of companies, without monetary
                ...
                bottom of our home page to submit your request. Please note, if
              ...
              <p className="italic hover:not-italic">
                ...
                or assist us in analysing how our Service is used. These third
                ...
                for any other purpose. 14. Analytics We may use third-party
                Service Providers to monitor and analyze the use of our Service.
                Vercel Analytics We also encourage you to review the
                Vercel&rsquo;s policy for safeguarding your data:{" "}
                <a href="https://vercel.com/docs/analytics/privacy-policy">
                  https://vercel.com/docs/analytics/privacy-policy
                </a>
                . 15. CI/CD tools We may use third-party Service Providers to
                automate the development process of our Service. GitHub GitHub
                is provided by GitHub, Inc. GitHub is a development platform to
                host and review code, manage projects, and build software. For
                more information on what data GitHub collects for what purpose
                and how the protection of the data is ensured, please visit
                GitHub Privacy Policy page:
                <a href="https://help.github.com/en/articles/github-privacy-statement">
                  {" "}
                  https://help.github.com/en/articles/github-privacy-statement{" "}
                </a>
                . 16. Behavioral Remarketing QAGPT, LLC. uses remarketing
                ...
                our Service. Google Ads (AdWords) Google Ads (AdWords)
                remarketing service is provided by Google Inc. You can opt-out
                of Google Analytics for Display Advertising and customize the
                ...
                17. Payments We may provide paid products and/or services within
                ...
                OpenAI: Their Privacy Policy can be viewed at:{" "}
                <a href="https://openai.com/policies/privacy-policy">
                  https://openai.com/policies/privacy-policy
                </a>
                MongoDB: Their Privacy Policy can be viewed at:{" "}
                <a href="https://www.mongodb.com/legal/privacy#:~:text=We%20act%20as%20a%20data,upload%20to%20our%20cloud%20services">
                  https://www.mongodb.com/legal/privacy#:~:text=We%20act%20as%20a%20data,upload%20to%20our%20cloud%20services
                </a>
                . 18. Links to Other Sites Our Service may contain links to
                other sites that are not operated by us. If you click a third
                ...
                party sites or services. 19. Children’s Privacy Our Services are
                ...
                take steps to remove that information from our servers. 20.
